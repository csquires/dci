...
python3 -m scripts.make_dag_pairs --folder fig1_data --npairs 100 --nnodes 10 --nneighbors 3 --changes independent --percent-added .05 --percent-removed .05
...
python3 -m scripts.run_dci --folder fig1_data --nsamples 1000 --dug fc --alphas .00001 .0001 .001 .01 .1
python3 -m scripts.run_dci --folder fig1_data --nsamples 10000 --dug fc --alphas .00001 .0001 .001 .01 .1
