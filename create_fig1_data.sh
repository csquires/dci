...
python3 -m scripts.make_dag_pairs --folder fig1_data --npairs 3 --nnodes 10 --nneighbors 3 --changes independent --percent-added .1 --percent-removed .1
python3 -m scripts.sample_dag_pairs --folder fig1_data --nsamples 1000
#python3 -m sample_dag_pairs --folder fig1_data --nsamples 10000
