...
parser.add_argument('--alpha1', type=float, nargs='?', default=.001, help='Significance threshold used in estimating D-UGs')
parser.add_argument('--alphas2', type=float, nargs='+', default=.001, help='Significance thresholds used in estimating D-DAGs')
